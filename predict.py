...
num2label = ['affirm_confirm', 'ask_age_wrong', 'ask_date_wrong', 'ask_gender_wrong', 
             'ask_name_wrong', 'deny_confirm','no_date', 'pick_date',  'provide_age',
             'provide_gender', 'provide_name']
